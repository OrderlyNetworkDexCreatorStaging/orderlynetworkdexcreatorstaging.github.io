import{aL as k,bb as v,aQ as N,b6 as x,aM as $,b1 as C,aE as u,l as c,_ as w,i as h,a1 as f,a3 as R,b8 as A,a$ as S,am as I,V as T,v as _,ba as b}from"./components-D3frubZn.js";import"./index-CeStS-fb.js";import"./preload-helper-ckwbz45p.js";import"./dayjs.min-CMrNtzaF.js";import"./dijkstra-BjYW_4FG.js";import"./browser-ponyfill-Dv8rXIhP.js";const E=k`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var g=function(e,t,o,i){var s=arguments.length,r=s<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(r=(s<3?n(r):s>3?n(t,o,r):n(t,o))||r);return s>3&&r&&Object.defineProperty(t,o,r),r};let p=class extends C{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return u`
    ...
    </wui-flex>`}};p.styles=[v,N,E];g([x({type:Array})],p.prototype,"networkImages",void 0);g([x()],p.prototype,"text",void 0);p=g([$("wui-compatible-network")],p);const O=k`
...
`;var m=function(e,t,o,i){var s=arguments.length,r=s<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,o,i);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(r=(s<3?n(r):s>3?n(t,o,r):n(t,o))||r);return s>3&&r&&Object.defineProperty(t,o,r),r};let d=class extends C{constructor(){var t,o;super(),this.unsubscribe=[],this.address=(t=c.getAccountData())==null?void 0:t.address,this.profileName=(o=c.getAccountData())==null?void 0:o.profileName,this.network=c.state.activeCaipNetwork,this.unsubscribe.push(c.subscribeChainProp("accountState",i=>{i?(this.address=i.address,this.profileName=i.profileName):w.showError("Account not found")}),c.subscribeKey("activeCaipNetwork",i=>{i!=null&&i.id&&(this.network=i)}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){if(!this.address)throw new Error("w3m-wallet-receive-view: No account provided");const t=h.getNetworkImage(this.network);return u` <wui-flex
    ...
    >
      ...
      .networkImages=${n}
    ></wui-compatible-network>`}onReceiveClick(){T.push("WalletCompatibleNetworks")}onCopyClick(){try{this.address&&(_.copyToClopboard(this.address),w.showSuccess("Address copied"))}catch{w.showError("Failed to copy")}}};d.styles=O;m([b()],d.prototype,"address",void 0);m([b()],d.prototype,"profileName",void 0);m([b()],d.prototype,"network",void 0);d=m([$("w3m-wallet-receive-view")],d);export{d as W3mWalletReceiveView};
