import{aL as O,b1 as b,h as C,P as T,L as j,b8 as m,aE as u,I as $,ba as l,aM as g,b6 as p,l as I,i as E,V as U,v as B,x as V,a$ as z,am as M,m as K,a1 as F,_ as W}from"./components-D3frubZn.js";import{O as c}from"./react-Cu0bfvWI.js";import"./index-CeStS-fb.js";import"./preload-helper-ckwbz45p.js";import"./dayjs.min-CMrNtzaF.js";import"./dijkstra-BjYW_4FG.js";import"./browser-ponyfill-Dv8rXIhP.js";import"./index-BbP3371Q.js";import"./hmac-BnSxb7TI.js";import"./sha3-C23X61-M.js";import"./PlatformAccessProvider-DkXBAdMY.js";import"./schemas-BT-kg2H9.js";import"./api-BpDaAzsX.js";import"./environment-DU02xlWB.js";import"./adminKeyAuth-BEbvQ3UV.js";import"./index-D3WzrsL4.js";import"./storage-CVnb7OLL.js";import"./walletError-1Zr9vhE7.js";import"./i18n-Ery4kb7T.js";import"./i18next-1ahWpAbd.js";import"./languages-InvAKIQr.js";import"./i18nInstance-C81hCH34.js";import"./useConnection-Ch1kfY0P.js";const N=O`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var v=function(t,e,i,o){var n=arguments.length,r=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(n<3?s(r):n>3?s(e,i,r):s(e,i))||r);return n>3&&r&&Object.defineProperty(e,i,r),r};let h=class extends b{constructor(){super(...arguments),this.disabled=!1,this.color="inherit",this.label="",this.feeRange="",this.loading=!1,this.onClick=null}render(){return u`
    ...
    `}onRampProvidersTemplate(){return this.providers.filter(e=>e.supportedChains.includes(I.state.activeChain??"eip155")).map(e=>u`
          ...
          ></w3m-onramp-provider-item>
        `)}onClickProvider(e){var i;c.setSelectedProvider(e),U.push("BuyInProgress"),B.openHref(((i=c.state.selectedProvider)==null?void 0:i.url)||e.url,"popupWindow","width=600,height=800,scrollbars=yes"),V.sendEvent({type:"track",event:"SELECT_BUY_PROVIDER",properties:{provider:e.name,isSmartAccount:z(I.state.activeChain)===M.ACCOUNT_TYPES.SMART_ACCOUNT}})}};S([l()],L.prototype,"providers",void 0);L=S([g("w3m-onramp-providers-view")],L);const q=O`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var x=function(t,e,i,o){var n=arguments.length,r=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(t,e,i,o);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(r=(n<3?s(r):n>3?s(e,i,r):s(e,i))||r);return n>3&&r&&Object.defineProperty(e,i,r),r};const J={USD:"$",EUR:"€",GBP:"£"},Z=[100,250,500,1e3];let f=class extends b{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=I.state.activeCaipAddress,this.loading=$.state.loading,this.paymentCurrency=c.state.paymentCurrency,this.paymentAmount=c.state.paymentAmount,this.purchaseAmount=c.state.purchaseAmount,this.quoteLoading=c.state.quotesLoading,this.unsubscribe.push(I.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),$.subscribeKey("loading",e=>{this.loading=e}),c.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return u`
    ...
    `}templateButton(){return this.caipAddress?u`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||$.open({view:"OnRampProviders"})}openModal(){$.open({view:"Connect"})}async onPaymentAmountChange(e){c.setPaymentAmount(Number(e.detail)),await c.getQuote()}async selectPresetAmount(e){c.setPaymentAmount(e),await c.getQuote()}};f.styles=G;x([p({type:Boolean})],f.prototype,"disabled",void 0);x([l()],f.prototype,"caipAddress",void 0);x([l()],f.prototype,"loading",void 0);x([l()],f.prototype,"paymentCurrency",void 0);x([l()],f.prototype,"paymentAmount",void 0);x([l()],f.prototype,"purchaseAmount",void 0);x([l()],f.prototype,"quoteLoading",void 0);f=x([g("w3m-onramp-widget")],f);export{d as W3mBuyInProgressView,L as W3mOnRampProvidersView,P as W3mOnrampFiatSelectView,k as W3mOnrampTokensView,f as W3mOnrampWidget,D as W3mWhatIsABuyView};
